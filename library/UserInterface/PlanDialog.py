...
__version__ = '1.0.0'
__license__ = 'GPLv3'
__help__ = 'https://github.com/wrssc/ray_scripts/wiki/Generate-Plan'
...
class PlanDialog:
    ...
    def __init__(self, patient=None, title='Plan Dialog', match=0.6, rx=3, priority=4, number_beamsets=1):
        """plan_info = UserInterface.PlanDialog(protocols)"""
        ...
        self.num_rx = rx
        # Note, this is probably the same as the fraction groups listed below
        self.beamsets_number = number_beamsets
        ...
        self.form.MaximumSize = System.Drawing.Size(1800, System.Windows.Forms.Screen.PrimaryScreen.WorkingArea.Bottom)
        ...
        # Add central panel
        self.central = System.Windows.Forms.TableLayoutPanel()
        self.central.ColumnCount = 1
        self.central.RowCount = 1
        self.central.GrowStyle = System.Windows.Forms.TableLayoutPanelGrowStyle.AddRows
        self.central.Padding = System.Windows.Forms.Padding(0, 0, 0, 0)
        self.central.BackColor = System.Drawing.Color.White
        self.central.AutoSize = True
        self.columns.Controls.Add(self.central)
    ...
    def show(self, case=None, exam=None):
        ...
        if self.status:
            ...
            self.values['beamsets_number'] = self.beamsets_number.SelectedItem
            self.values['options'] = {}
            ...
            self.values['target_number'] = self.target_number.Text
