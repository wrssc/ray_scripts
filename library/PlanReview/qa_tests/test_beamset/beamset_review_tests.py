# Test for the Beamsets
import numpy as np
import logging
from collections import namedtuple
import re
from PlanReview.review_definitions import *
from PlanReview.utils import get_approval_info, subtract_roi_sources, \
    get_roi_names_from_type, get_roi_list, match_roi_name, get_machine
...
def check_pacemaker(rso):
    ...
    pacer_prv_roi_list = match_roi_name(roi_names=[PACEMAKER_PRV_NAME], roi_list=roi_list)
...
#                 message_str = "Dose grid may be too large for this plan based on fractional
#                 dose " \
