""" Generate Plan
    ...
    This script is dosimetrists and others to select all essential elements of a Raystation
    plan including:
    -Demographics
    -Structure Matching and Choice of Targets
    -Beam Data
    -Clinical Goals
...
def main():
    ...
    # Start script status
    status = UserInterface.ScriptStatus(steps=['Enter Demographics Information',
    ...
    status.next_step(text='In order to finalize the structure list and generate beamsets, ' +
                          'please fill out the displayed form ' +
                          'with information about the plan. Once completed, click Continue.')

    tpo = UserInterface.PlanDialog(patient=patient, title='Plan Dialog', match=0.6, rx=3, priority=priority)
