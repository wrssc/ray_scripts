...
def make_externalclean(
    ...
    while check_structure_exists(case=case,structure_name=temp_ext,exam=examination,optino="Check"):
        i += 1
        temp_ext = 'temp_ext'+str(i)
    temp_ext_geom = 
    ...
    if not structure_approved(case=case, roi_name=structure_name):
        ...
        make_boolean_structure(patient=patient, case=case, examination=examination, **overlap_defs)
