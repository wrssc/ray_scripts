...
def iter_standard_rois(etree):
    ...
    for r in etree.iter('roi'):
        ...
        try:
            roi["SourcesA"] = str(r.find('SourcesA').text).split(",")
            roi["OperationA"] = r.find('SourcesA').attrib['operation']
            roi["MarginTypeA"] = r.find('SourcesA').attrib['margin_type']
            ...
            roi["SourcesA"]=None
        try:
            roi["SourcesB"] = str(r.find('SourcesB').text).split(",")
            roi["OperationB"] = r.find('SourcesB').attrib['operation']
            roi["MarginTypeB"] = r.find('SourcesB').attrib['expansion']
        except AttributeError:
            roi["SourcesB"]=None 
        try:
            roi
